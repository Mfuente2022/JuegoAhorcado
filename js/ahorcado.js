...
function gameOver() {
    if(document.querySelector(".state-nodisplay") != null){
        ...
        game.textContent = "OOPS";/*palabra[i].toUpperCase()*/

        const over = document.createElement("div");
        over.textContent = "PERDISTE";/*palabra[i].toUpperCase()*/
...
function youWin() {
    if(document.querySelector(".state-nodisplay") != null){
        ...
        you.textContent = "Muy bien";/*palabra[i].toUpperCase()*/

        const win = document.createElement("div");
        win.textContent = "GANASTE!";/*palabra[i].toUpperCase()*/
